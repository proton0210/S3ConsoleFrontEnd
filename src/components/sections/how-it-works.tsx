...
const data = [
  {
    ...
    content:
      "Open Buckets by ServerlessCreed and securely connect using your AWS credentials. The application establishes a secure connection to your AWS account with industry-standard authentication protocols.",
    image: "/1-profile.png",
  ...
  },
  {
    ...
    content:
      "Buckets by ServerlessCreed automatically detects and loads all your existing AWS profiles and regions. Switch between different accounts and environments with a single click—no manual configuration required.",
