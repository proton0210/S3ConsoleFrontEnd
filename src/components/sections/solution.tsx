...
export default function Component() {
  return (
    <Section
      ...
      description="No more wrestling with web consoles or wrestling with CLI commands. ServerlessCreed Buckets brings the simplicity of modern desktop apps to AWS S3 management."
