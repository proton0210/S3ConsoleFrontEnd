...
const testimonials = [
  {
    quote:
      "ServerlessCreed Buckets has completely transformed how our team manages S3 storage. The intuitive interface and one-click presigned URLs have saved us countless hours. It's now an essential tool in our  workflow.",
