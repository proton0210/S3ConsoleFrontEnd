...
const ITEMS: ShowcaseItem[] = [
  {
    ...
    alt: "Serverless Buckets uploading a file to an S3 bucket directly from a URL",
  },
  {
    type: "video",
    title: "Drop Zones",
    ...
    alt: "Serverless Buckets Drop Zone letting an external user upload files to S3",
  },
  {
    type: "video",
    ...
    alt: "Serverless Buckets authenticating using AWS CLI credentials",
  },
  {
    type: "video",
    ...
    alt: "Serverless Buckets searching for objects across multiple S3 buckets",
  },
  {
    type: "image",
    ...
    alt: "Serverless Buckets transferring objects between two S3 buckets",
  },
];
