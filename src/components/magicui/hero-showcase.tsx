...
const ITEMS: ShowcaseItem[] = [
  ...
  },
  {
    ...
    alt: "Buckets by ServerlessCreed Drop Zone letting an external user upload files to S3",
  },
  {
    type: "video",
    ...
    alt: "Buckets by ServerlessCreed authenticating using AWS CLI credentials",
  },
  {
    type: "video",
    ...
    alt: "Buckets by ServerlessCreed searching for objects across multiple S3 buckets",
  },
  {
    type: "image",
    ...
    alt: "Buckets by ServerlessCreed transferring objects between two S3 buckets",
  },
];
