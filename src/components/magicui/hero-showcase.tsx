...
const ITEMS: ShowcaseItem[] = [
  {
    ...
    alt: "ServerlessCreed Buckets uploading a file to an S3 bucket directly from a URL",
  },
  {
    type: "video",
    title: "Drop Zones",
    ...
    alt: "ServerlessCreed Buckets Drop Zone letting an external user upload files to S3",
  },
  {
    type: "video",
    ...
    alt: "ServerlessCreed Buckets authenticating using AWS CLI credentials",
  },
  {
    type: "video",
    ...
    alt: "ServerlessCreed Buckets searching for objects across multiple S3 buckets",
  },
  {
    type: "image",
    ...
    alt: "ServerlessCreed Buckets transferring objects between two S3 buckets",
  },
];
