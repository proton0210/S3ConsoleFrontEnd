...
export function StructuredData({ type = "website", data }: StructuredDataProps) {
  ...
  const websiteSchema = {
    ...
    disambiguatingDescription: siteConfig.nonAffiliation,
  ...
  const softwareSchema = {
    ...
    name: siteConfig.name,
    alternateName: ["Desktop Client for Amazon S3", "S3 Desktop App"],
    disambiguatingDescription: siteConfig.nonAffiliation,
    description: siteConfig.description,
    applicationCategory: "DeveloperApplication",
    ...
    softwareVersion: process.env.NEXT_PUBLIC_DESKTOP_VERSION || "2.7.2",
