  ...
  useEffect(() => {
    ...
    const processPaymentSuccess = async () => {
      try {
        ...
        // Always update the paid status when coming to success page
        // This ensures the payment is processed even if there's a timing issue
        if (user) {
        ...
        // Always trigger confetti animation
        confetti({
          particleCount: 100,
          spread: 70,
          origin: { y: 0.6 },
