...
export default function DownloadsPage() {
  ...
  const handleMacDownload = () => {
    const downloadLink =
      "https://s3consolemac.s3.us-east-1.amazonaws.com/S3Console-2.6.1-arm64.dmg";

    const link = document.createElement("a");
    link.href = downloadLink;
    link.download = "S3Console-2.6.1-arm64.dmg";
  ...
  const handleLinuxDownload = () => {
    const downloadLink =
      "https://s3consolelinux.s3.ap-south-1.amazonaws.com/s3Console_2.6.1_arm64.deb";

    const link = document.createElement("a");
    link.href = downloadLink;
    link.download = "s3Console_2.6.1_arm64.deb";
    document.body.appendChild(link);
    link.click();
    document.body.removeChild(link);
  ...
  const proceedWithWindowsDownload = () => {
    ...
    const downloadLink =
      "https://s3consolewindows.s3.ap-south-1.amazonaws.com/S3Console-Setup-2.6.1.exe";

    const link = document.createElement("a");
    link.href = downloadLink;
    link.download = "S3Console-Setup-2.6.1.exe";
    document.body.appendChild(link);
    link.click();
    document.body.removeChild(link);
