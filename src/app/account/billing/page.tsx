          ...
          <Section className="py-20">
            <div className="max-w-xl mx-auto bg-white rounded-2xl border border-slate-200 shadow-sm p-10 text-center">
              ...
              <p className="text-slate-600 mb-6">
                ...
                unlock ServerlessCreed Buckets Pro on up to two machines.
              </p>
              <Link
                href="/pricing"
            ...
            <div className="flex items-start justify-between gap-4 flex-wrap">
              <div>
                ...
                <p className="text-slate-600 mt-1.5">
                  Manage your ServerlessCreed Buckets Pro plan, payment method, and invoices.
                </p>
              </div>
              <button
                ...
                <div>
                  ...
                  <div className="flex items-baseline gap-3 flex-wrap">
                    <h2 className="text-2xl font-bold text-slate-900">
                      ServerlessCreed Buckets Pro · {tierInfo.name}
                    </h2>
                    <StatusBadge
                      tier={tier}
            ...
            <div className="space-y-6">
              ...
              {isLifetime && (
                <div className="bg-gradient-to-br from-violet-50 to-violet-100 rounded-2xl border border-violet-200 shadow-sm p-6">
                  ...
                  <p className="text-xs text-slate-700 mb-4">
                    You own ServerlessCreed Buckets Pro forever. No renewals, no recurring
