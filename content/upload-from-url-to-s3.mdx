...
The whole pipeline runs locally in the desktop application on your machine, talks directly to S3 with your local AWS credentials, and never proxies your data through any Buckets by ServerlessCreed server. There is no Buckets by ServerlessCreed-hosted backend in the data path.
