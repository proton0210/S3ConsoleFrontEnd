...
- **The app framework.** Buckets by ServerlessCreed is an Electron desktop app built on Chromium (the same engine that renders the interface you actually use). A cross-platform Electron app carries that engine with it. This is most of the rest of the size, and it is typical of apps built with this framework.
