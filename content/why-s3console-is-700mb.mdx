...
- **The app framework.** Buckets by ServerlessCreed is a cross-platform desktop app built on a Chromium-based framework (the same engine that renders the interface you actually use). The application carries that engine with it. This is most of the rest of the size, and it is typical of apps built with this kind of framework.
